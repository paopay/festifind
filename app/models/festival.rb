class Festival < ActiveRecord::Base
  ...
  #   query_url = "http://developer.echonest.com/api/v4/playlist/static?api_key=" + ECHONEST_API_KEY + "&artist_id=songkick:artist:" + songkick_artist_id + "&sort=song_hotttnesss-desc&results=3&type=artist&bucket=tracks&bucket=id:rdio-US&limit=true"
